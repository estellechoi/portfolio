export const TITLE = "Front-end engineer Youjin's portfolio";
...
export const prjts = [
	{
		...
		img: [
			...
			{
				src: "/portfolio/images/bhc2.png",
				alt: "Bad Habit Club preview no.2",
			},
			{
				src: "/portfolio/images/bhc3.png",
				alt: "Bad Habit Club preview no.3",
			},
			{
				src: "/portfolio/images/bhc4.png",
				alt: "Bad Habit Club preview no.4",
			},
			{
				src: "/portfolio/images/bhc5.png",
				alt: "Bad Habit Club preview no.5",
			},
			{
				src: "/portfolio/images/bhc6.png",
				alt: "Bad Habit Club preview no.6",
			},
			{
				src: "/portfolio/images/bhc7.png",
				alt: "Bad Habit Club preview no.7",
			},
			{
				src: "/portfolio/images/bhc8.png",
				alt: "Bad Habit Club preview no.8",
			},
			{
				src: "/portfolio/images/bhc9.png",
				alt: "Bad Habit Club preview no.9",
			},
		],
		desc: [],
	},
